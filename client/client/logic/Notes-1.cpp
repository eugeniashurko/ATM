...
int main()
{
	unsigned int sum1 = 340;
	give_some_money(sum1);
	cout<<endl;
	unsigned int sum2 = 840;
	give_some_money(sum2);
	cout<<endl;
	unsigned int sum3 = 1;
	give_some_money(sum3);
	cout<<endl;
	unsigned int sum4 = -340;
	give_some_money(sum4);
	cout<<endl;
	unsigned int sum5 = 25;
	give_some_money(sum5);
	cout<<endl;
